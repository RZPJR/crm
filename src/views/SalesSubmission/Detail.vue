<template>
    <v-container fill-height class="main-container">
        <div class="box-start">
            ...
            <v-row v-if="items.task_image_url" class="my24">
                <v-col cols="12" class="-mt24">
                    <span class="grey--text">Photo:</span>
                    <v-row class="mt5">
                        <div class="img-product ma-2" v-for="(item, idx) in items.task_image_url" :key="idx">
...
<script>
    ...
    export default {
        ...
        methods: {
            renderData() {
                HTTP.get("/sales/assignment/submission/" + this.$route.params.id, {
                    params: {
